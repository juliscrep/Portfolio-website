...
const AboutSection = () => {
  ...
  return (
    <section className='text-white' id="about">
        <div className={`${style.aboutSection} md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16`}>
           <Image src='/images/escritorio3.jpg' width={550} height={550} alt='about image' className={`${style.aboutImage} rounded-t-xl rounded-b-xl mt-10`}/>
